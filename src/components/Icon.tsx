// Onda 3 · Repaginação visual — ícones de linha monocromáticos (estilo Lucide).
// Herdam a cor via `currentColor`, então o tom vem do texto/classe ao redor:
// cinza na moldura (navegação, estrutura) e cor só onde é status (o container
// aplica text-red/amber/emerald). Substituem os emojis coloridos do chrome.
// Funciona em server e client components (é só SVG inline).
...
const PATHS = {
  ...
  gamepad:
    '<line x1="6" x2="10" y1="12" y2="12"/><line x1="8" x2="8" y1="10" y2="14"/><line x1="15" x2="15.01" y1="13" y2="13"/><line x1="18" x2="18.01" y1="11" y2="11"/><rect x="2" y="6" width="20" height="12" rx="2"/>',
  clipboardCheck:
  ...
  // Status (o container define a cor)
  alertTriangle:
